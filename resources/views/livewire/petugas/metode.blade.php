        ...
        <div class="card">
            ...
            <div class="card-body" id="divFormSupp">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="txtNama" placeholder="Masukkan nama penguji" value="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <a class="btn btn-primary" href="javascript:void(0)" onclick="prosesApriori()">Mulai Rekomendasi</a>
                </div>
            </div>
...
<script>
    var rProsesApriori = server + "prosesAnalisaApriori";
    ...
    function prosesApriori() {
        ...
        confirmQuest('info', 'Konfirmasi', 'Mulai pembentukan rekomendasi ?', function (x) {konfirmasiApriori(ds)});
    }
    ...
    function konfirmasiApriori(ds)
    {
        ...
        axios.post(rProsesApriori, ds).then(function(res){
            ...
            renderPage('hasilAnalisa/'+kdPengujian, 'Hasil Analisa');
            
            // window.location.replace('/hasilAnalisa/'+kdPengujian);
        });
    }
